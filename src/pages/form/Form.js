    ...
    return (
      <div className="form-page">
        ...
        <div className="options">
          {console.log(itemsObj) || itemsObj.currentCategory !== "Shells"
            ...
            : itemsObj.currentItems.map(opt => (
                <div key={opt}>
                  <Checkbox
                    id={opt}
                    name={itemsObj.currentCategory}
                    checked={this.state.selectedShell === opt}
                    value={opt}
                    onClick={this.handleSelectShell}
                    onChange={this.toggleActions}
                  ></Checkbox>
                  {opt}
                  <br />
                </div>
